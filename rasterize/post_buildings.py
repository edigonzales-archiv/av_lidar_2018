...
INPATH = "/Samsung_T5/99_Derivate/buildings/tif.orig"
OUTPATH = "/Samsung_T5/99_Derivate/buildings/tif"
TMPPATH = "/tmp/buildings/"
BUFFER = 10
...
for feature in layer:
    ...
    infile = os.path.join(INPATH, basename + "_buildings.tif")
